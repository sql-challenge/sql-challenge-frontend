...
PORT=3000
NODE_ENV=production
DATABASE_URL=postgresql://challenge_user:G7%23kpL2!mZq9Xv@db:5432/db_gestao?sslmode=disable
...
sudo cp /home/admin/sql-challenge-frontend/nginx/sql-challenge.conf /etc/nginx/sites-available/sql-challenge
